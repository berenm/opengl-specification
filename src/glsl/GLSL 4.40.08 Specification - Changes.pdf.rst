...
8 Built-in Functions...................................................................................................................138
  ...
  8.15 Geometry Shader Functions...........................................................................................181
  8.16 Shader Invocation Control Functions.............................................................................183
  8.17 Shader Memory Control Functions................................................................................184
9 Shading Language Grammar for Core Profile........................................................................186
10 Normative References...........................................................................................................202
...
1.6   Deprecation
      Note that while this section is true of GLSL in general, version 4.40 has no deprecated features in it.
      Previously deprecated features have been moved to the compatibility profile and no new features have
      been deprecated.
      Previous versions of the The OpenGL Shading Language has deprecated some features. These are clearly
      called out in this specification as “deprecated”. They are still present in this version of the language, but
...
are targeted for potential removal in a future version of the shading language. The OpenGL API has a
...
3.1   Character Set and Phases of Compilation
      ...
      scheme. Outside of commentsAfter preprocessing, only the following characters are allowed in the
      resulting stream of GLSL tokens:
            ...
            feed.
      A compile-time error will be given if any other character is used outside a commentin a GLSL token.
...
3.4   Comments
      ...
      its terminating new line. If a comment resides entirely within a single line, it is treated syntactically as a
      single space. New lines are not eliminated by comments.
...
4.1.7   Opaque Types
        ...
        qualifier will qualify the opaque handle, while the memory qualifier will qualify the object it as is a handle
        to.
...
Consumption Eerrors are based on static use only. Compilation may generate a warning, but not an error,
...
arrays of these types, but not structures. It is a compile-time error to declare a vertex shader input
...
optionally have a size declared. For geometry shaders, the The array size will be set by, (or if provided
must be consistent with) the input layout declaration(s) establishing the type of input primitive, as
...
or arrays or structures of these. It is a compile-time error to declare a fragment shader input containing
...
shader. be float, single-precision floating-point vectors, signed or unsigned integers or integer vectors, or
arrays of any these. only Fragment outputs can It is a compile-time error to declare any double-precision
type, matrix, or structure as ana fragment shader output that contains any of the following:
    •       A Boolean type (bool, bvec2, bvec3, bvec4)
...
•   All the uniform variables and uniform blocks declared inof a program. This spans all compilation
    units linked together within one program.
•   All the buffer blocks ofvariables declared in a program.
...
outputs with double-precision components, the stride must be a multiple of 8, otherwise it must be a
       ...
       For example:
          ...
          layout (xfb_buffer = 13, xfb_offset = 12) out block2 {
...
packed uniform or shader storage block across programs or stages will generally failAccessing the same
...
range.
When multiple arguments are listed in a layout declaration, the affect effect will be the same as if they
were declared one at a time, in order from left to right, each in turn inheriting from and overriding the
result from the previous qualification.
For example
...
4.5   Interpolation Qualifiers
      ...
      match if their interpolation qualifiers (or lack thereof) are not the same.must match, otherwise the link
        ...
        command will fail.interface stage cross-The type and presence of interpolation qualifiers of variables with
...
4.7.2   Precision Qualifiers
        Any single-precision floating-point declaration, or any integer declaration, or sampler declaration can
        have the type preceded by one of these precision qualifiers:
...
return types and all qualifiers must also match, and it is the same function being declared. For example,
    ...
    vec4 f(in ivec4 x, out udvec4 y);                    // (C) okay, different argument type
...
apply to different sets of calling argument types:
    ...
    f(vec4, uvec4);                 //   exact match of vec4 f(in vec4 x, out iuvec4 y)
    f(vec4, ivec4);                 //   matched to vec4 f(in vec4 x, out vec4 y)
                                    //     (C) not relevant, can't convert vec4 to
                                    //     ivec4. (A) better than (B) for 2nd
                                    //     argument (rule 23), same on first argument.
...
6.1.2   Subroutines
      ...
      dynamically uniform expressions. dynamically indexed at use.
...
vertices in the primitive being shaded. Which vertex the layer comes from is undefinedis discussed in
section 11.3.4.6 “Layer and Viewport Selection” of the OpenGL Specification. It might be undefined, so
it is best to write the same layer value for all vertices of a primitive. If a shader statically assigns a value
to gl_Layer, layered rendering mode is enabled. See section 11.3.4.5 “Geometry Shader Outputs”and
section 9.4.9 “Layered Framebuffers” of the OpenGL Graphics System Specification for more
information. If a shader statically assigns a value to gl_Layer, and there is an execution path through the
shader that does not set gl_Layer, then the value of gl_Layer is undefined for executions of the shader that
take that path.
...
makes no static assignment to gl_Layer, the input value gl_Value in the fragment stage will be zero.
Otherwise, the fragment stage will read the same value written by the geometry stage, even if that value is
out of range. If a fragment shader contains a static access to gl_Layer, it will count against the
...
maximum number of samples.the same size described above. If the fragment shader statically assigns a
value to gl_SampleMask, the sample mask will be undefined for any array elements of any fragment
shader invocations that fail to assign a value. If a shader does not statically assign a value to
gl_SampleMask, the sample mask has no effect on the processing of a fragment.
...
7.3   Built-In Constants
      ...
      dependent, but must be at least the value shown.
         ...
         const   int gl_MaxComputeAtomicCounterBuffers = 81;
         ...
         const   int    gl_MaxCombinedTextureImageUnits = 9680;
...
8.14   Noise Functions
       ...
       Noise functions are available in all shader stages. They are stochastic functions that can be used to
       increase visual complexity. Values returned by the following noise functions give the appearance of
       randomness, but are not truly random. The noise functions below are defined to have the following
       characteristics:
...
8.15   Geometry Shader Functions
       ...
       variables associated with stream. These include gl_PointSize, gl_ClipDistance, gl_Layer, gl_Position,
       gl_PrimitiveID and gl_ViewportIndex. The values of all output variables for all output streams are
       undefined after a call to EmitStreamVertex(). If a geometry shader invocation has emitted more vertices
       than permitted by the output layout qualifier max_vertices, the results of calling EmitStreamVertex()
       are undefined.
